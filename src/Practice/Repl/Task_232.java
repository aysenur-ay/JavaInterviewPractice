...
a method graduationRequirements that returns a String. The (default) behavior of graduationRequirements
is to return a String stating "d years of study", where d is the value of the duration instance variable

Write a subclass LawSchool that contains:
a (default) constructor (No-Arg) that invokes the superclass constructor
