...
public class StoreProductClass {
    public static void main(String[] args) {
        //StoreProduct s1 = new StoreProduct("Label", 15,"home decor", false);
        //       StoreProduct s2 = new StoreProduct("Label2", 20, 5);
        //       StoreProduct s3 = new StoreProduct("Label3", "Kitchen", 50, 10);
        //       StoreProduct s4 = new StoreProduct("Label4", "Living room", 100, 5, true);

        //       s1.expired(false);
        //       s2.sale(10);
        //       s3.getDiscountedPrice(0.2);
